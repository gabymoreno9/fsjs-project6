/*t.js-0.8;(c)2017 Mntn(r) <http://mn.tn/> c/o Benjamin Lips <g--AT--mn.tn>;
Licensed under the MIT License <https://mit-license.org/>;
For documentation see https://github.com/mntn-dev/t.js or https://mn.tn/dev/t.js*/
...
;(function($){
    ...
    return this.each(function(){
     ...
     var _o=opts,_c=content,c=$(this),o,oo,tt=!1,bb=-1,z='\u200b',q='12qwertyuiop[]\asdfghjkl;zxcvbnm,./~!@#$%^&*()_+:1234567890-=op'.split([]),
     ...
     _c===''&&(_c='<del>*</del>');
     if(c.data('is_typing')){if(_c=='pause'){c.data('pause',((t(_o,'b'))?oo_=_o:((c.data('pause'))?(oo_=!1):(oo_=!!1))));c.data('blinking',(oo_)?1:0);}
     ...
     if(_c=='add'&&$('.t-container',c)[0]){
      ...
      var _o=$.extend({t:!!1,delay:!1,speed:75,speed_vary:!1,caret:'\u258e',tag:'span',blink:!1,blink_perm:!!1,repeat:-3,
      ...
      if(t(_o.caret,'s')&&!$('.t-caret',c)[0]){
       ...
       _o.blink&&c.append(z)&&(_$=setInterval(function(){if(($$$.parent().data('blinking')|(v=(oo.css('visibility')[0]=='h')))||_o.blink_perm)oo.css({visibility:(v)?'visible':'hidden'});},(t(_o.blink))?_o.blink:_o.speed*((_o.speed_vary)?4:5)));
      }
     ...
     replace(/<\!\-\-([\s\S]+?)\-\->/g,'$1').replace(/<ins>([^0-9])<\/ins>/g,'$1').
     replace(/<(img|br|input|hr)(.*?)[\/]?>/g,'<#$1$2/>').replace(/<ins>\s*(\d*[.]?\d*)\s*<\/ins>/g,'<ins data-ins="$1"></ins>').
     replace(/<ins>([\s\S]+?)<\/ins>/g,function(a,b){return('<#ins>'+b.replace(/<(?!#)/g,'<#')+'</ins>');}).
     replace(/<(del.*?data-del=")(.*?)(".*?)><\/(del>)/g,'<#$1$2$3><#/$4$2<#/$4').
     replace(/<del(.*?)>([\s\S]*?)<\/del>/g,function(a,b,c,d){i=(c.match(/data-ins=\"(.*?)\"/));i=(i&&i[1])?i[1]:.25;
     ...
     $$=setInterval(function(){
      ...
      if(t(k)){if(--k){tt=!tt;b((c.data().ins<=.25)?0:1);return;}k=(c.data().ins)?'//':d.shift();}
